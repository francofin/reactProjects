...
class SignUp extends Component{
    ...
    constructor(){
        super();
        this.state = {
            lowerPartOfForm: <button onClick={this.showInputs} type ="button" className="sign-up-button">Sign up with email</button>,
            email:"",
            password:""
        }
    }
        ...
        <div className="sign-up-wrapper">
            <div className="col m12">
                <div className="input-field" id="email">
                    ...
                    <input type="text" className="browser-default" placeholder="Email" onChange={props.changeEmail} />
                </div>
            </div>
            <div className="col m12">
                <div className="input-field" id="password">
                    <div className="form-label">Password</div>
                    <input type="password" className="browser-default" placeholder="Password" onChange={props.changePassword} />
                </div>
            </div>
            <div className="col m12">
